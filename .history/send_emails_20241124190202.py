  ...
  <body>
    <div class="container">
      <div class="header">
        ...
        <h1>Entrepreneurship Week 2024</h1>
        <p>Organized by CRCE Cell, JAIN (Deemed-to-be University)</p>
      </div>
      <div class="content">
        ...
        <p>
          ...
          Cell across all campuses of
          <strong>JAIN (Deemed-to-be University)</strong>!
        </p>
        <p>
          The highlight of this week is our flagship event, the
          <strong>Make-A-Thon</strong>, happening on
          <strong>25th November 2024</strong> at the
          <strong
            >Faculty of Engineering and Technology, JAIN (Deemed-to-be
            University) Global Campus, Kanakapura</strong
          >.
        </p>
        <h2>Event Timeline</h2>
        <ul>
          <li><strong>Reporting Time:</strong> 8:30 AM</li>
        </ul>
        <p>
          <em
            >Ensure you report promptly by 8:30 AM for a smooth registration
            process.</em
          >
        </p>
        <h2>What to Bring</h2>
        <ul>
          ...
          <li><strong>Extension cords</strong> and <strong>chargers</strong></li>
        ...
        <p>
          <a href="https://bit.ly/412TUFg" id="under-line">Rules and Regulations</a><br />
          <a href="https://bit.ly/3CANSRZ" id="under-line">Make-A-Thon Guidelines</a>
        </p>
      ...
      <div class="footer">
        <p>
          <strong>Entrepreneurship Week 2024</strong><br />Organized by CRCE
          Cell, JAIN (Deemed-to-be University)
        </p>
        <p>
          <em
...
def main():
    ...
    # Email template
    subject = "Jain University : Make-a-thon 2024"
    # body = body
