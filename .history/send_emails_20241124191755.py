    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <ul>
          ...
          <li>
            <strong>Extension cords</strong> and <strong>chargers</strong>
          </li>
        ...
        <p>
          1. <a href="https://bit.ly/412TUFg" id="under-line"
            >Rules and Regulations</a
          ><br /><br />
          2. <a href="https://bit.ly/3CANSRZ" id="under-line"
...
def main():
    ...
    # File input
    file_path = "./emails_extracted.csv"
    try:
